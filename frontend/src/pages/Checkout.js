...
const Checkout = () => {
  ...
  const formik = useFormik({
   ...
   const checkOutHandler = async()=>{
    ...
    if(!res){
      alert("RazorpaySDK failed to load")
      return;
    }
  
    const result = await axios.post("http://localhost:8000/api/user/order/checkout",{amount:totalAmount+200},config)
    if(!result)
    {
    ...
    console.log(amount);
    const options = {
      key: "rzp_test_imjbVTQFZ6sHsf", // Enter the Key ID generated from the Dashboard
      amount: amount,
      currency: currency,
      name: "eShop",
        ...
        <div className="row">
          <div className="col-7">
            <div className="checkout-left-data">
              <h3 className="website-name">E-shop</h3>
              <nav
              ...
              >
                ...
                <div className="flex-grow-1">
                  ...
                  >
                    ...
                    <option value="Bagmati">Gandaki</option>
                    <option value="Bagmati">Lumbini</option>
                    <option value="Bagmati">Koshi</option>
                  </select>
                  <div className="error ms-2 my-1">
          ...
          <div className="col-5">
            ...
            <div className="border-bottom py-4">
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <p className="mb-0 total-price">Rs 200</p>
              </div>
            </div>
            <div className="d-flex justify-content-between align-items-center border-bottom py-4">
              <h4 className="total">Total</h4>
              <h5 className="total-price">
                Rs {totalAmount ? totalAmount + 200 : "0"}
              </h5>
            </div>
          </div>
        </div>
